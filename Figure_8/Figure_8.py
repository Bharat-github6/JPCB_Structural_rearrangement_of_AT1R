...
sopc_r1i=pd.read_csv('data/descriptor_inactive', delim_whitespace=True)
...
sopc_r2i=pd.read_csv('data/descriptor_active', delim_whitespace=True)
...
window=20
ax1.plot(time1, sopc_r1i[['TM1-TM6']].rolling(window).mean()*10, color='tab:red', label='Rep1')
...
ax2.plot(time1, sopc_r1i[['TM3-TM6']].rolling(window).mean()*10, color='tab:red', label='Rep1')
...
ax3.plot(time1, sopc_r1i[['NpxxY']].rolling(window).mean()*10, color='tab:red', label='Rep1')
...
ax4.plot(time1, sopc_r1i[['N300_S115']].rolling(window).mean()*10, color='tab:red', label='Rep1')
...
ax5.plot(time1, sopc_r1i[['L78_Y297']].rolling(window).mean()*10,color='tab:red', label='Inactive @$t=0$')
