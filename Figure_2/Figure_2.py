...
ax.plot(time_popcr1,(popc_r1[['TM1-TM6']].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax.plot(time_dmpcr1,(dmpc_r1[['TM1-TM6']].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
ax.plot(time_sopcr1,(sopc_r1[['TM1-TM6']].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
...
ax1.plot(time_popcr1,(popc_r1[['TM3-TM6']].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax1.plot(time_dmpcr1,(dmpc_r1[['TM3-TM6']].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
ax1.plot(time_sopcr1,(sopc_r1[['TM3-TM6']].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
...
ax2.plot(time_popcr1,(popc_r1[['NpxxY']].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax2.plot(time_dmpcr1,(dmpc_r1[['NpxxY']].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
ax2.plot(time_sopcr1,(sopc_r1[['NpxxY']].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
ax2.set_xlim(0,5)
...
ax3.plot(time_popcr1,(popc_r1[['N300_S115']].rolling(window).mean()*10),color='tab:green',label='AT1R/-/- (POPC)')
ax3.plot(time_dmpcr1,(dmpc_r1[['N300_S115']].rolling(window).mean()*10),color='tab:red', label='AT1R/-/- (DMPC)')
ax3.plot(time_sopcr1,(sopc_r1[['N300_S115']].rolling(window).mean()*10), color='tab:blue', label='AT1R/-/- (SOPC)')
...
ax6.plot(time_dmpcr1,(dmpc_r1[['L78_Y297']].rolling(window).mean()*10),color='tab:red', label='DMPC (di-C14:0)')
ax6.plot(time_popcr1,(popc_r1[['L78_Y297']].rolling(window).mean()*10),color='tab:green',label='POPC (C16:0,C18:1)')
ax6.plot(time_sopcr1,(sopc_r1[['L78_Y297']].rolling(window).mean()*10), color='tab:blue', label='SOPC (C18:0,C18:1)')
...
plt.savefig('Figure_1.svg', dpi=600)
