...
sopca_r2=sopca_r1[['time', 'TM1-TM6','TM1-ICL2','TM5-ICL2','TM6-H8', 'TM3-TM6', 'NpxxY','N300_S115', 'L78_Y297']]
...
plt.plot(time_dmpcr1, dmpc_r1[['TM1-TM6']].rolling(window).mean()*10, color='tab:red', label='DMPC')
plt.plot(time_popcr1, popc_r1[['TM1-TM6']].rolling(window).mean()*10, color='tab:green', label='POPC')
plt.plot(time_sopcr1, sopc_r1[['TM1-TM6']].rolling(window).mean()*10, color='tab:blue', label='SOPC')
...
plt.plot(time_dmpcr1, dmpc_r1[['TM3-TM6']].rolling(window).mean()*10, color='tab:red', label='DMPC')
plt.plot(time_popcr1, popc_r1[['TM3-TM6']].rolling(window).mean()*10, color='tab:green', label='POPC')
plt.plot(time_sopcr1, sopc_r1[['TM3-TM6']].rolling(window).mean()*10, color='tab:blue', label='SOPC')
...
for line in plt.gca().get_lines(): line.set_clip_on(False)
rect = Rectangle((5.2,4),1.5, 16, clip_on=False, ec='k', fill=False)
ax1.add_patch(rect)
...
plt.plot(time_dmpcr1, dmpc_r1[['NpxxY']].rolling(window).mean()*10, color='tab:red', label='DMPC')
plt.plot(time_popcr1, popc_r1[['NpxxY']].rolling(window).mean()*10, color='tab:green', label='POPC')
plt.plot(time_sopcr1, sopc_r1[['NpxxY']].rolling(window).mean()*10, color='tab:blue', label='SOPC')
...
plt.plot(time_dmpcr1, dmpc_r1[['N300_S115']].rolling(window).mean()*10, color='tab:red', label='DMPC')
plt.plot(time_popcr1, popc_r1[['N300_S115']].rolling(window).mean()*10, color='tab:green', label='POPC')
plt.plot(time_sopcr1, sopc_r1[['N300_S115']].rolling(window).mean()*10, color='tab:blue', label='SOPC')
...
plt.plot(time_dmpcr1, dmpc_r1[['L78_Y297']].rolling(window).mean()*10, color='tab:red', label='DMPC')
plt.plot(time_popcr1, popc_r1[['L78_Y297']].rolling(window).mean()*10, color='tab:green', label='POPC')
plt.plot(time_sopcr1, sopc_r1[['L78_Y297']].rolling(window).mean()*10, color='tab:blue', label='SOPC')
...
plt.savefig('Figure_3_sup.png', dpi=600)
plt.savefig('Figure_3_sup.svg', dpi=600)
#plt.close()
