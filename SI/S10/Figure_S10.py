...
ax1.plot(time_i1, i1[['TM1-TM6']].rolling(window).mean()*10,color='tab:red', label='Intermediate')
...
ax2.plot(time_i1, i1[['TM3-TM6']].rolling(window).mean()*10,color='tab:red', label='Intermediate')
...
ax3.plot(time_i1, i1[['NpxxY']].rolling(window).mean()*10, color='tab:red',label='Intermediate')
...
ax4.plot(time_i1, i1[['N300_S115']].rolling(window).mean()*10,color='tab:red', label='Intermediate')
...
ax5.plot(time_i1, i1[['L78_Y297']].rolling(window).mean()*10, color='tab:red',label='d(TM1-TM6)=28 $\AA$ @$t=0$')
...
plt.savefig('Figure_S10.png', dpi=600)
plt.savefig('Figure_S10.svg', dpi=600)
