...
ST10_r1= pd.read_csv('ST10_rep1', delim_whitespace=True)
...
ST15_r1= pd.read_csv('ST15_rep1', delim_whitespace=True)
...
ax.text(-0.24, 1.09, 'a', transform=ax.transAxes, ha='center', fontsize=13, fontweight='bold')
ax1.text(-0.24, 1.09, 'b', transform=ax1.transAxes, ha='center', fontsize=13, fontweight='bold')
ax2.text(-0.24, 1.09, 'c', transform=ax2.transAxes, ha='center', fontsize=13, fontweight='bold')
ax3.text(-0.24, 1.09, 'd', transform=ax3.transAxes, ha='center', fontsize=13, fontweight='bold')
ax6.text(-0.24, 1.09, 'e', transform=ax6.transAxes, ha='center', fontsize=13, fontweight='bold')
ax7.text(-0.24, 1.09, 'f', transform=ax7.transAxes, ha='center', fontsize=13, fontweight='bold')
fig = plt.gcf()
