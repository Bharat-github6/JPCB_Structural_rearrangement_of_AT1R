...
ax1.plot(time_i2, i2[['TM1-TM6']].rolling(window).mean()*10,color='tab:red', label='Intermediate')
...
ax2.plot(time_i2, i2[['TM3-TM6']].rolling(window).mean()*10,color='tab:red', label='Intermediate')
...
ax3.plot(time_i2, i2[['NpxxY']].rolling(window).mean()*10, color='tab:red',label='Intermediate')
...
ax4.plot(time_i2, i2[['N300_S115']].rolling(window).mean()*10,color='tab:red', label='Intermediate')
...
ax5.plot(time_i2, i2[['L78_Y297']].rolling(window).mean()*10, color='tab:red',label='d(TM1-TM6)=28 $\AA$ @$t=0$')
