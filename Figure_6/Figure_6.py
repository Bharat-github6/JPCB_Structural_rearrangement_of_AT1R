...
time_a1=np.linspace(0,30, len(a1))
...
ax1.plot(time_a2, a2[['TM1-TM6']].rolling(2).mean()*10, color='tab:blue', label='Active')
ax1.plot(time_i2, i2[['TM1-TM6']].rolling(window).mean()*10,color='tab:green', label='Intermediate')
...
ax2.plot(time_a2, a2[['TM3-TM6']].rolling(window).mean()*10,color='tab:blue', label='Active')
ax2.plot(time_i2, i2[['TM3-TM6']].rolling(window).mean()*10,color='tab:green', label='Intermediate')
...
ax3.add_patch(rect)
for line in plt.gca().get_lines(): line.set_clip_on(False)
ax3.plot(time_a2, a2[['NpxxY']].rolling(window).mean()*10,color='tab:blue', label='Active')
ax3.plot(time_i2, i2[['NpxxY']].rolling(window).mean()*10, color='tab:green',label='Intermediate')
...
ax4.plot(time_a2, a2[['N300_S115']].rolling(window).mean()*10,color='tab:blue', label='Active')
ax4.plot(time_i2, i2[['N300_S115']].rolling(window).mean()*10,color='tab:green', label='Intermediate')
...
ax5.plot(time_a2, a2[['L78_Y297']].rolling(window).mean()*10,color='tab:blue', label='d(TM1-TM6)=25 $\AA$ @$t=0$')
ax5.plot(time_i2, i2[['L78_Y297']].rolling(window).mean()*10, color='tab:green',label='d(TM1-TM6)=28 $\AA$ @$t=0$')
