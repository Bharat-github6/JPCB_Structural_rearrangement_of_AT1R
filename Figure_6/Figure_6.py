...
ax.plot(time_ST5r1,(ST5_r1[['TM1-TM6']].rolling(window).mean()*10),color='tab:green')
ax.plot(time_ST10r1,(ST10_r1[['TM1-TM6']].rolling(window).mean()*10),color='tab:red')
ax.plot(time_ST15r1,(ST15_r1[['TM1-TM6']].rolling(window).mean()*10), color='tab:blue')
ax.plot(time_ST20r1,(ST20_r1[['TM1-TM6']].rolling(window).mean()*10), color='grey')
width=0.3
start=5.5
sp = 0.4
...
ax1.plot(time_ST5r1,(ST5_r1[['TM3-TM6']].rolling(window).mean()*10),color='tab:green')
ax1.plot(time_ST10r1,(ST10_r1[['TM3-TM6']].rolling(window).mean()*10),color='tab:red')
ax1.plot(time_ST15r1,(ST15_r1[['TM3-TM6']].rolling(window).mean()*10), color='tab:blue')
ax1.plot(time_ST20r1,(ST20_r1[['TM3-TM6']].rolling(window).mean()*10), color='grey')
width=0.3
start=5.5
sp = 0.4
...
ax2.plot(time_ST5r1,(ST5_r1[['NpxxY']].rolling(window).mean()*10),color='tab:green')
ax2.plot(time_ST10r1,(ST10_r1[['NpxxY']].rolling(window).mean()*10),color='tab:red')
ax2.plot(time_ST15r1,(ST15_r1[['NpxxY']].rolling(window).mean()*10), color='tab:blue')
ax2.plot(time_ST20r1,(ST20_r1[['NpxxY']].rolling(window).mean()*10), color='grey')
width=0.3
start=5.5
sp = 0.4
...
ax3.plot(time_ST5r1,(ST5_r1[['N300_S115']].rolling(window).mean()*10),color='tab:green')
ax3.plot(time_ST10r1,(ST10_r1[['N300_S115']].rolling(window).mean()*10),color='tab:red')
ax3.plot(time_ST15r1,(ST15_r1[['N300_S115']].rolling(window).mean()*10), color='tab:blue')
ax3.plot(time_ST20r1,(ST20_r1[['N300_S115']].rolling(window).mean()*10), color='grey')
width=0.3
start=5.5
sp = 0.4
...
ax6.plot(time_ST5r1,(ST5_r1[['L78_Y297']].rolling(window).mean()*10),color='tab:green',label='$\gamma=$ 5 mN/m')
ax6.plot(time_ST10r1,(ST10_r1[['L78_Y297']].rolling(window).mean()*10),color='tab:red',label='$\gamma=$ 10 mN/m')
ax6.plot(time_ST15r1,(ST15_r1[['L78_Y297']].rolling(window).mean()*10), color='tab:blue',label='$\gamma=$ 15 mN/m')
ax6.plot(time_ST20r1,(ST20_r1[['L78_Y297']].rolling(window).mean()*10), color='grey',label='$\gamma=$ 20 mN/m')
width=0.3
start=5.5
sp = 0.4
...
plt.savefig('Figure_6.svg', dpi=600)
